...
import ErrorHandlerMiddleware from './middlewares/error-handler.middleware.js'; //에러처리를 위한 import
...
// 에러 핸들링 미들웨어를 등록합니다.
app.use(ErrorHandlerMiddleware); // 미들웨어는 등록된 순서로 실행되기 때문에 라우터 설정코드 하단에 위치해야함.
